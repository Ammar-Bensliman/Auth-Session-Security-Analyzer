...
app.add_middleware(
    ...
    allow_origin_regex=r"https?://.*",  # Permet de matcher dynamiquement n'importe quel domaine/IP Docker pour renvoyer l'origine exacte (nécessaire avec allow_credentials=True)
